...
+ Great find! Thank you @swe-covis! Moved alias view to `Ctrl-A` [Issue #156](https://github.com/kswapd/k13s/issues/156)
+ Added toggle autoscroll via `s` key [Issue #155](https://github.com/kswapd/k13s/issues/155)
