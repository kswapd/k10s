...
* [Issue #972](https://github.com/kswapd/k10s/issues/972) Default color is no longer transparent.
* [Issue #933](https://github.com/kswapd/k10s/issues/933) Unable to cordon node.

## Resolved PRs

* [PR #982](https://github.com/kswapd/k10s/pull/982) Fix typo
* [PR #976](https://github.com/kswapd/k10s/pull/976) Add OneDark color theme
* [PR #975](https://github.com/kswapd/k10s/pull/982) Handling non json lines as raw with red color
* [PR #968](https://github.com/dserailed/k9s/pull/968) Disable filtering on help screen ... and broke the build ;)
* [PR #960](https://github.com/kswapd/k10s/pull/960) Handle empty port list in PortForward view
